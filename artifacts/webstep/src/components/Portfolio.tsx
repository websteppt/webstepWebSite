        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg md:text-xl leading-relaxed mb-12 max-w-lg">
              Landing page focada em apresentar de maneira simples e atrativa os
              serviços oferecidos e com isso aumentar as marcações. Com
              integração WhatsApp e otimização para pesquisa local.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-[1px] bg-white/10 border border-white/10 mb-12 w-full">
              <div className="bg-[#ef4444]/10 border border-[#ef4444] p-6 flex flex-col justify-center">
                <span className="text-2xl font-black text-[#ef4444]">✓</span>
                <span className="text-xs uppercase font-bold text-white/60 mt-2">
                  Mais pedidos online
                </span>
              </div>
