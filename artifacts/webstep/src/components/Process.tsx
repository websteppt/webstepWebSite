...
const steps = [
  {
    num: "01",
    title: "Descoberta",
    desc: "Analisamos o seu negócio, concorrentes e objetivos para definir a direção certa.",
    icon: Compass
  },
  {
    num: "02",
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[#ef4444] uppercase tracking-widest font-bold text-sm">Processo</span>
          </div>
